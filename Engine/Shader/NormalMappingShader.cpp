...
namespace Craft
{
	NormalMappingShader::NormalMappingShader(const std::string& diffuseTexture, const std::string& specularTexture, const std::string& normalTexture) : Shader(L"NormalMapping")
	{
